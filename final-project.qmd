...
ggplot(fire_asthma, aes(total_area, total_hosp_capita)) +
  geom_point()
```
...
ggplot(asthma_aqi, aes(max_aqi, log(age_adjusted_hospitalization_rate))) +
  geom_point()
ggplot(asthma_aqi, aes(log(max_aqi), log(age_adjusted_hospitalization_rate))) +
  geom_point()
...
ggplot(asthma_aqi, aes(unhealthy_sum, log(hosp_per_100k))) +
  geom_point()
ggplot(asthma_aqi, aes(log(unhealthy_sum), hosp_per_100k)) +
  geom_point()
...
ggplot(asthma_aqi, aes(per_capita_income, log(hosp_per_100k))) +
  geom_point()
ggplot(asthma_aqi, aes(log(per_capita_income), log(hosp_per_100k))) +
  geom_point()
...
```{r}
median_mod <- lm(log(hosp_per_100k) ~ max_aqi, data = asthma_aqi)
summary(median_mod)
